...
class _ChatState extends State<Chat> {
  ...
  late List<ConversationOtherUserIdItem> conversationWithUser = [];
    ...
    return Scaffold(
      ...
      body: ChangeNotifierProvider.value( value: viewModel,
        child: Consumer<BlogsViewModel>(builder: (context, value, child) {
          if(viewModel.conversationLoading) return const Center(child: CircularProgressIndicator());
          else
            conversationWithUser = viewModel.conversationMessages;
              ...
              children: [
                Expanded(
                  ...
                  return Row(
                     mainAxisAlignment: MainAxisAlignment.start,
                     children: [
                       Message( conversationOtherUserIdItem: conversationWithUser[index],),
                     ],
                   );
                    },
                    itemCount: conversationWithUser.length,
